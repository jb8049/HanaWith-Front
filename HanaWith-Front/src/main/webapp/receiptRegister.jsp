	...
	<div class="comment-form-receipt" id="comment-custom-receipt">
		...
		<div class="container">
			<ul class="nav nav-tabs" style="margin-left: 50px;">
				<li class="nav-item"><a class="nav-link active" aria-current="page" href="javascript:" onclick="doRegisterCall()">영수증 등록</a></li>
				<li class="nav-item"><a class="nav-link" href="javascript:" onclick="doListCall()">영수증 목록</a></li>
				<li class="nav-item"><a class="nav-link" href="javascript:" onclick="doProcessCall()">처리 대기</a></li>
